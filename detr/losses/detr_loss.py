...
from detr.data.utils import box_cxcywh2xyxy, interpolate, nested_tensor_from_tensor_list
from detr.utils.ops import generalized_box_iou
...
class DETRCriterion(nn.Module):
    ...
    Code from original DETR repository.
    ...
    def loss_cardinality(self, outputs, targets, indices, num_boxes):
        ...
        The absolute error in the number of predicted non-empty boxes
    ...
    def loss_boxes(self, outputs, targets, indices, num_boxes):
        ...
        The bounding boxes, the L1 regression loss and the GIoU loss
        ...
        loss_giou = 1 - torch.diag(generalized_box_iou(box_cxcywh2xyxy(src_boxes), box_cxcywh2xyxy(target_boxes)))
